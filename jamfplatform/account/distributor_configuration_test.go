...
func TestGetDistributorConfiguration(t *testing.T) {
	...
	result, err := c.GetDistributorConfiguration(context.Background())
	if err != nil {
		t.Fatal(err)
	}
	if result == nil {
...
func TestGetDistributorConfiguration_NotFound(t *testing.T) {
	...
	_, err := c.GetDistributorConfiguration(context.Background())
	if err == nil {
...
func TestUpdateDistributorConfiguration(t *testing.T) {
	...
	err := c.UpdateDistributorConfiguration(context.Background(), &DistributorConfiguration{})
	if err != nil {
		t.Fatal(err)
	}
}
