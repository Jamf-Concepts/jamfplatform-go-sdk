...
//   - filter: Query in the RSQL format, allowing to filter buildings collection. Default
//     filter is empty query - returning all results for the requested page. Fields
//     allowed in the query: name, streetAddress1, streetAddress2, city,
//     stateProvince, zipPostalCode, country. This param can be combined with
//     paging and sorting. Example: filter=city=="Chicago" and name=="*build*".
...
//     paging and sorting. Example: name=="*buildings*".
