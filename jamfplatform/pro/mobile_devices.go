...
//     `osSupplementalBuildVersion`, `osVersion`, `osRapidSecurityResponse`, `ipAddress`,
//     `itunesStoreAccountActive`, `mobileDeviceId`, `languages`, `lastEnrolledDate`,
...
//     `lostModeEnabled`, `managed`, `model`, `modelIdentifier`, `modelNumber`, `modemFirmwareVersion`,
//     `preferredVoiceNumber`, `serialNumber`, `supervised`, `timeZone`, `udid`, `usedSpacePercentage`,
//     `wifiMacAddress`, `building`, `department`, `emailAddress`, `fullName`, `userPhoneNumber`,
//     `position`, `room`, `username`, `appleCareId`, `lifeExpectancyYears`, `poNumber`, `purchasePrice`,
//     `purchasedOrLeased`, `purchasingAccount`, `purchasingContact`, `vendor`, `activationLockEnabled`,
//     `blockEncryptionCapable`, `dataProtection`, `fileEncryptionCapable`, `passcodeCompliant`,
//     `passcodeCompliantWithProfile`, `passcodeLockGracePeriodEnforcedSeconds`, `passcodePresent`,
