...
//     `objectType:asc`. Multiple sort criteria are supported and must be separated
//     with a comma.
//     Example: `sort=objectId:asc,objectType:desc`.
//   - filter: Query in the RSQL format, allowing filter of site object information.
...
//     List of `objectType` options (case-insensitive) ["Computer", "Peripheral",
//     "Licensed Software", "Licensed Software Template", "Policy", "macOS
//     Configuration Profile", "Restricted Software", "Managed Preference Profile",
//     "Computer Group", "Mobile Device", "Apple TV", "Android Device", "User
//     Group", "iOS Configuration Profile", "Mobile Device App", "E-book", "Mobile
//     Device Group", "Classroom", "Advanced Computer Search", "Advanced Mobile
//     Search", "Advanced User Search", "Advanced User Content Search", "Computer
//     Invitation", "Mobile Device Invitation", "Mobile Device Enrollment Profile",
//     "Device Enrollment Program Instance", "Mobile Device Prestage", "Computer
//     DEP Prestage", "Enrollment Customization", "VPP Location", "VPP
//     Subscription", "VPP Invitation", "VPP Assignment", "User", "Network
//     Integration", "Mac App", "App Installer", "Self Service Plugin", "Software
//     Title", "Patch Software Title Summary", "Patch Policy", "Patch Software
//     Title Configuration", "Change Password", "Mobile Device Inventory",
//     "Computer Inventory", "Change Management", "Licensed Software License"].
