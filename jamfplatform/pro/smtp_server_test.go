...
func TestGetSmtpServerV2(t *testing.T) {
	...
	mux.HandleFunc("/pro/v2/smtp-server", func(w http.ResponseWriter, r *http.Request) {
	...
	result, err := c.GetSmtpServerV2(context.Background())
	if err != nil {
		t.Fatal(err)
	}
	if result == nil {
...
func TestGetSmtpServerV2_NotFound(t *testing.T) {
	c, mux := testServerWithOpts(t, WithTenantID("t-test"))
	mux.HandleFunc("/pro/v2/smtp-server", func(w http.ResponseWriter, _ *http.Request) {
	...
	_, err := c.GetSmtpServerV2(context.Background())
	if err == nil {
...
func TestUpdateSmtpServerV2(t *testing.T) {
	...
	result, err := c.UpdateSmtpServerV2(context.Background(), &SmtpServerV2{})
	if err != nil {
		t.Fatal(err)
	}
	if result == nil {
...
func TestListSmtpServerAllowedAuthTypesV2(t *testing.T) {
	c, mux := testServerWithOpts(t, WithTenantID("t-test"))
	mux.HandleFunc("/pro/v2/smtp-server/allowed-auth-types", func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet {
			t.Errorf("method = %s, want GET", r.Method)
		}
		writeJSON(t, w, http.StatusOK, map[string]any{})
...
func TestListSmtpServerAllowedAuthTypesV2_NotFound(t *testing.T) {
	c, mux := testServerWithOpts(t, WithTenantID("t-test"))
	mux.HandleFunc("/pro/v2/smtp-server/allowed-auth-types", func(w http.ResponseWriter, _ *http.Request) {
		writeJSON(t, w, http.StatusNotFound, map[string]any{
			"httpStatus": 404,
			"traceId":    "trace-nf",
			"errors":     []map[string]string{{"code": "NOT_FOUND", "field": "id", "description": "not found"}},
...
func TestListSmtpServerHistoryV1(t *testing.T) {
	c, mux := testServerWithOpts(t, WithTenantID("t-test"))
	mux.HandleFunc("/pro/v1/smtp-server/history", func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet {
			t.Errorf("method = %s, want GET", r.Method)
		}
		writeJSON(t, w, http.StatusOK, map[string]any{
...
func TestTestSmtpServerV1(t *testing.T) {
	c, mux := testServerWithOpts(t, WithTenantID("t-test"))
	mux.HandleFunc("/pro/v1/smtp-server/test", func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodPost {
			t.Errorf("method = %s, want POST", r.Method)
		}
