...
func TestGetCacheSettingsV1(t *testing.T) {
	...
	mux.HandleFunc("/pro/v1/cache-settings", func(w http.ResponseWriter, r *http.Request) {
...
func TestGetCacheSettingsV1_NotFound(t *testing.T) {
	c, mux := testServerWithOpts(t, WithTenantID("t-test"))
	mux.HandleFunc("/pro/v1/cache-settings", func(w http.ResponseWriter, _ *http.Request) {
