...
func TestGetAccountPreferencesV2(t *testing.T) {
	...
	mux.HandleFunc("/pro/v2/account-preferences", func(w http.ResponseWriter, r *http.Request) {
...
func TestGetAccountPreferencesV2_NotFound(t *testing.T) {
	c, mux := testServerWithOpts(t, WithTenantID("t-test"))
	mux.HandleFunc("/pro/v2/account-preferences", func(w http.ResponseWriter, _ *http.Request) {
